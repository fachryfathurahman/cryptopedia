...
public class NewsQueryUtils {
    ...
    public static List<News> extractNews(String SAMPLE_JSON_RESPONSE) {
        ...
        try {
            ...
            for (int i=0;i<articles.length();i++){
                ...
                String imageLink=news.getString("urlToImage");

                if (!title.equals(null)||!description.equals(null)||!link.equals(null)||!imageLink.equals(null)){
                    News.add(new News(title,description,link,imageLink));
                }
